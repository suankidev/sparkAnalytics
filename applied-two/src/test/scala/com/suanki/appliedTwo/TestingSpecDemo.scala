...
class TestingSpecDemo
  ...
  def lookupWeather(
    ...
    if (!weatherService.operational()) None
    else Some(weatherService.getWeather(icaoCode))
  }
  ...
  describe("Retrieving the weather from the weather service") {
    ...
    it("should call the lookup weather with different codes when necessary") {
      ...
      lookupWeather(stubWS, "SFO").get should have(
        Symbol("temp")(65.0),
        Symbol("precip")(0.3),
        Symbol("pressure")(1008.0)
      )

      lookupWeather(stubWS, "PDX").get should have(
        Symbol("temp")(55.0),
        Symbol("precip")(0.0),
        Symbol("pressure")(1012.0)
      )
...
//    they(
//      "should test .reverse.reverse on any string gives you back the original string"
//    ) {
//      forAll(strGen) { str: String =>
//        println(str)
//        str.toString.reverse.reverse should be(str)
//      }
//    }
//
