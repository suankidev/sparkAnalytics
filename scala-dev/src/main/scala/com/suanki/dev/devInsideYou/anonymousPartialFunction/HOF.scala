...
object HOF extends App {
  ...
  /** hof function that accept other function as input function that produce
    * other function as output
    *
    * -> every HOF can control the flow of passed function, may be you can call
    * 2 times
    */
