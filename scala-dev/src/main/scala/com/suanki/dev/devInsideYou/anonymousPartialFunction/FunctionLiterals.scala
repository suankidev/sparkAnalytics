...
//    println(totalFunction(randomNumber))
    ...
    val totalFunctionsWithoutSyntaticSugar: SimpleFunctionTwo[Int, String] =
      new SimpleFunctionTwo[Int, String] {
        override def apply(num: Int): String = s"""\"${num}\""""
      }

    val totalFunctionsWithoutSyntaticSugarOne: Function1[Int, String] =
